...
export const SMART_PROFILES = {
  ...
  small: {
    ...SMART_PROFILE,
    avoidBurningBigTrump: false, // A/B 4×36: БЕЗ флага результат лучше (раздел 1.4 roadmap: ≈ 2 п.п.).
                                 // За столом 3–4 человек отбой чаще доигрывают подкидыванием, и
                                 // «поберечь козырного короля, взяв карты» оборачивается лишним взятием.
    dumpPairs: true,             // A/B: +3,2 п.п. на 24×2, на 36×4 разница в пределах шума ->
                                 // оставлен включённым (полезен, когда стол сводится к дуэли).
  },
  ...
  large: {
    ...
    finishOffWeakOpponent: true, // за большим столом добить игрока с 1–2 картами по-прежнему выгодно:
                                 // он выбывает, и стол быстрее сводится к дуэли.
  },
};
