...
function simpleBotDecide(state, playerId, legalActions){
  ...
  if(defends.length>0){
    ...
    if(wouldUseTrump && transfer) return transfer;
    return cheapest;
  }
